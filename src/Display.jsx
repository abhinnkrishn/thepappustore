        ...
        return (
            ...
            <div className="model">
                ...
                <div className="model-details">
                    <h3 className="model-title"> <strong>DIVERSE WOMENS WHITE PEPLUM TOP </strong></h3>
                    <h5 className="model-price"> &#x20B9;5,999</h5>
                    <p>Avaliable: <span>In Stock</span></p>
                    <img src={star} alt="Ratings" width="15px" /> <h6 className="model-rating" >4.3</h6>
                    <hr />
                    ...
                    <p className="model-wishlist"><strong>Wishlist</strong></p>
                    <br/>
                    <br/>
                    <h6>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt ex optio est corrupti assumenda quidem deleniti dolor, enim inventore alias aliquid cum maiores dignissimos voluptas delectus atque. Dolore aliquam deserunt quisquam excepturi architecto quaerat minus consectetur tempora? Saepe, facilis quisquam?</h6>
                </div>
            </div>
            <Slider />
            <Footer />
